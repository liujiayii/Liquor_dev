      ...
      routes: [
        {
          ...
          routes: [
            ...
            {
              path: '/mall', name: 'mall', icon: 'shop', routes: [
                {path: '/mall/mallList', name: 'mallList', component: './mall/mallList'},
                {path: '/mall/sales', name: 'sales', component: './mall/sales'},
                {path: '/mall/allot', name: 'allot', component: './mall/allot'},
                {path: '/mall/distributor', name: 'distributor', component: './mall/distributor'}
              ],
            },
            {
              path: '/goods', name: 'goods', icon: 'gift', routes: [
                {path: '/goods/goodsList', name: 'goodsList', component: './goods/goodsList'},
                {path: '/goods/module', name: 'module', component: './goods/module'},
                {path: '/goods/coupon', name: 'coupon', component: './goods/coupon'},
              ],
            },
            {
              path: '/order', name: 'order', icon: 'profile', routes: [
                {path: '/order/orderList', name: 'orderList', component: './order/orderList'},
                {path: '/order/setting', name: 'setting', component: './order/setting'},
              ],
            },
            {
              path: '/other', name: 'other', icon: 'setting', routes: [
                {path: '/other/customer', name: 'customer', component: './other/customer'},
                {path: '/other/carousel', name: 'carousel', component: './other/carousel'},
                {path: '/other/code', name: 'code', component: './other/code'},
                {path: '/other/log', name: 'log', component: './other/log'},
                {path: '/other/password', name: 'password', component: './other/password'},
              ],
            },
            {component: './404',},
          ],
